...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/share/zhouzhengguang/backup/data/sintel', dstype='clean',
...
class FlyingChairs(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/share/zhouzhengguang/backup/data/FlyingChairs_release/data'):
...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None, root='/share/zhouzhengguang/backup/data/flyingthings3d', split='training', dstype='frames_cleanpass'):
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/share/zhouzhengguang/backup/data/KITTI'):
...
def fetch_dataloader(args, TRAIN_DS='C+T+K+S+H'):
    ...
    if args.stage == 'chairs':
        ...
        clean_dataset = FlyingThings3D(aug_params, dstype='frames_cleanpass', split='training', root=args.things_root)
        final_dataset = FlyingThings3D(aug_params, dstype='frames_finalpass', split='training', root=args.things_root)
        train_dataset = clean_dataset + final_dataset

    elif args.stage == 'sintel':
        aug_params = {'crop_size': args.image_size, 'min_scale': -0.2, 'max_scale': 0.6, 'do_flip': True}
        things = FlyingThings3D(aug_params, dstype='frames_cleanpass', root=args.things_root)
        sintel_clean = MpiSintel(aug_params, split='training', dstype='clean', root=args.sintel_root)
        sintel_final = MpiSintel(aug_params, split='training', dstype='final', root=args.sintel_root)        
...
if __name__ == '__main__':
    ...
    final_dataset = FlyingThings3D(dstype='frames_finalpass', split='training', root='/share/sunshangkun/flyingthings3d')
    final_dataset[0]