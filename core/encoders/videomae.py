...
@register_model
def videomae_small(pretrained=False, **kwargs):
...
@register_model
def videomae_base(pretrained=False, **kwargs):
    model = VisionTransformer(
...
if __name__ == '__main__':
    a = torch.ones([1, 6, 3, 368, 768]).cuda()
    model = VideoMAEImageProcessor.from_pretrained("videomae-base-finetuned-kinetics")
    b = model(a, return_tensors="pt") # pytorch tensors
    print(b.shape)